...
###Change any alr34 paths to your HPC paths
...
def read_params():
    ...
    rm.add_argument('--rm_baboon', required=False, default=False, action='store_true', help="Remove P. anubis genome")
    ...
    p.add_argument('-x', '--bowtie2_indexes', required=False, default='/home/alr34/databases/bowtie2_indexes',
...
def screen_contaminating_dnas(input_dir, qced_r1_r2, bowtie2_indexes, keep_intermediate, rm_baboon, rm_hsap, rm_rrna, rm_mmus,
    ...
    for R in qced_r1_r2:
        ...
        for cont_dna in cont_dnas:
            ...
            if not os.path.isfile('{}.fastq'.format(os.path.join(input_dir, outf))):
                cmd = ('bowtie2 -x {} -U {} -p {} --very-sensitive --end-to-end --un {}.fastq'
...
if __name__ == "__main__":
    ...
    screened_r1_r2 = screen_contaminating_dnas(args.input_dir, qced_r1_r2, args.bowtie2_indexes, args.keep_intermediate, args.rm_baboon,
